...
app.controller('UserProfileController', ['$scope', '$http', '$cookieStore', 'UserProfileService', 'BlogService', 'EventService','JobService',
                         '$location', '$rootScope',
             function($scope, $http,  $cookieStore, UserProfileService, BlogService, EventService, JobService,
    ...
    self.fetchAllBlogs = function()
	{
		BlogService.fetchAllBlogs().then(function(d)
		{
			self.blogs = d;
			console.log(d);
		    console.log("Fetch all user blogs - userprofile")
		},
