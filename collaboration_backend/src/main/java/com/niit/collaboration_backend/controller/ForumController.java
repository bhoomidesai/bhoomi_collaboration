...
public class ForumController {
	...
	public ResponseEntity<UserForumComments> createUserForumComment(@RequestBody UserForumComments userforumcmt)
	{
		...
		userforumcmt.setUseremail("bhoomi@niit.com");
	...
	@RequestMapping(value = "/deleteforumadmin/{forumid}", method = RequestMethod.POST)
	public ResponseEntity<UserForum> deleteForumAdmin(@PathVariable("forumid") int forumid)	{

		log.debug("calling => getdeleteforum() method");
		boolean flag = service.deleteForumAdmin(forumid);
		return new ResponseEntity<UserForum>(HttpStatus.OK);
	}	
}
